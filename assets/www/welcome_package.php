...
<div data-dom-cache="false" data-role="page" class="pages" id="home" data-theme="a">
        ...
        <p>Hello student: </p>
        <p style="text-align: justify">Receive a fraternal welcome from the organization Student Platform for Engineering Education Development (SPEED) and the Association of Faculties of Engineering Colmbiana (ACOFI) to 9° Global Forum for Students of Engineering (GSF). First, let me congratulate you for the valuable work they have proposed and which we will announce in the 9° GSF 2013 in Cartagena, this being very important for Engineering Education in the World and through SPEED will give continuity and visibility necessary. </p>
        <p style="text-align: justify">As a student, you will participate in all activities of the GSF (to be held on 22, 23 and September 24) and WEEF (to be held on 25, 26 and September 27). The GSF will be held with the participation of students from different parts of the world, which is then added to WEEF activities which involve deans and professionals in engineering education.</p>
        
        
                    <br>
            <ul class="nav-list">
                <li><a href="colombia.php">Colombia - An Introduction<span>&gt;</span></a></li>
                <li><a href="9thgsf_schedule.php">Schedule<span>&gt;</span></a></li>
                <li><a href="cartagena.php">Cartagena<span>&gt;</span></a></li>
                <li><a href="university.php">Technological University of Bolivar - UTB<span>&gt;</span></a></li>
                <li><a href="maps.php">Other Important Maps<span>&gt;</span></a></li>
                <li><a href="gallery.php">Landmarks<span>&gt;</span></a></li>
                <li><a href="directions.php">To Get to Cartagena<span>&gt;</span></a></li>
                <li><a href="exchange.php">Money Exchange<span>&gt;</span></a></li>
                <li><a href="rules.php">Rules and Dress Code<span>&gt;</span></a></li>
                <li><a href="lang.php">Useful Phrases<span>&gt;</span></a></li>
            </ul>
