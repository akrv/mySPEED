...
<div data-dom-cache="false" data-role="page" class="pages" id="home" data-theme="a">
	...
	<div data-role="content" data-theme="a" class="minus-shadow">
            <div class="cherry-slider" style="height: 150px;">
    ...
    <div anim="drop" anim-speed="500" anim-direction="down" anim-position-right="0" anim-position-top="20" class="anim-item">  <img src="images/logo_buld.png" width="180" height="90" /></div>
                ...
                <div anim="blind" anim-speed="700" anim-direction="left" anim-position-left="0" anim-position-top="40" class="anim-item"><p class="little-padding aa">PLATFORM FOR</p></div>
                <div anim="drop" anim-speed="700" anim-direction="down" anim-position-left="0" anim-position-top="68" class="anim-item"><p class="little-padding white-bg gray-border">ENGINEERING EDUCATION</p></div>
                <div anim="drop" anim-speed="700" anim-direction="down" anim-position-left="0" anim-position-top="98" class="anim-item"><p class="little-padding white-bg gray-border">DEVELOPMENT</p></div>
    <div anim="drop" anim-speed="500" anim-direction="down" anim-position-right="0" anim-position-top="20" class="anim-item">  <img src="images/logo_buld.png" width="150" height="70" /></div>
          ...
          <div anim-action="break" anim="fade" anim-speed="700" class="anim-item"></div>
            ...
            <br>
            <ul class="nav-list">
               <li><a href="http://www.worldspeed.org/images/stories/documents/SPEED_bylaws.pdf">SPEED Bylaws.pdf (English)<span>&gt;</span></a></li>
              <li><a href="http://www.worldspeed.org/images/stories/Regimento_Interno.pdf">SPEED Regimento Interno.pdf (Portuguese)<span>&gt;</span></a></li>
              <li><a href="http://www.worldspeed.org/images/stories/Spanish_Bylaws.pdf">SPEED Reglamento.pdf (Spanish)<span>&gt;</span></a></li>
            </ul>
	<!-- /content -->
    
    <p><strong>Note:</strong> We're translating our bylaws for others languages and we need your help. We have a version of the bylaws in English, Spanish and Portuguese, however our goal is to extend for others languages (e.g. Italian, German, Indian, Russian, Chinese, etc.) and your help is very important.
Please, if you domain some language and you would like to contribute with us, send an email to
<br><br> 
claudio.silva@worldspeed.org 
<br><br> 
Procedure is very simple. All you have to do is:<br>
1. Get yourselves a copy of the Bylaws (I can send a version in format .doc to be more easy to edit)<br>
2. Translate manually all the topics or get a help from a friend or software<br>
3. Send to claudio.silva@worldspeed.org<br>
4. Ready! You have helped more students around the World to know about us!</p>
    <p><br>
      <strong> Note: We will recognize the translator by putting his/her name into the document. :-) </strong>
    </p>
