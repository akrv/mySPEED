...
<div anim="blind" anim-speed="700" anim-direction="left" anim-position-left="0" anim-position-top="20" class="anim-item"><p class="little-padding aa">STUDENT'S</p></div>
  ...
  <div anim="fade" anim-speed="2000" class="anim-item wait-item"></div>
		...
		<div class="gallery-collection white-content-box">
			<h2>8th Global Students Forum - Buenos Aires, Argentina (2012)</h2>
			<ul class="gallery column-split  one-column">
				<li>
					</li><li><iframe width="560" height="315" src="//www.youtube.com/embed/tEhCjIzlevU" frameborder="0" allowfullscreen></iframe></li>
            ...
            <div class="gallery-collection white-content-box">
			<h2>7th Global Students Forum - Portugal(2011)</h2>
			<ul class="gallery column-split  one-column">
				<li>
					</li><li><iframe width="560" height="315" src="//www.youtube.com/embed/oeTPiqX3Os0" frameborder="0" allowfullscreen></iframe></li>
			...
			<ul class="gallery column-split  three-column">
				<li><iframe src="http://player.vimeo.com/video/941386" width="95%" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe></li>
				<li><iframe src="http://player.vimeo.com/video/48227936" width="95%" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe></li>
