...
<div data-dom-cache="false" data-role="page" class="pages" id="home" data-theme="a">
	...
	<div data-role="content" data-theme="a" class="minus-shadow">
            ...
            <div class="white-content-box">
                <h2>Mission</h2>
                <p align="justify">Through engineering education initiatives and collaboration with academia, industry, society and government, SPEED is committed to improving the future of engineering education whilst embracing the considerable engineering challenges being faced in the 21st century.</p>
                <h2>Vision</h2>
                <p align="justify">SPEED strives to empower students to become a factor of change in EE by providing them with the skills, knowledge and resources necessary to become a global engineer and show them how they can think globally and act locally.</p>
            </div>
	</div><!-- /content -->
