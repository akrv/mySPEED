...
<div data-dom-cache="false" data-role="page" class="pages" id="home" data-theme="a">
	...
	<div data-role="content" data-theme="a" class="minus-shadow">
		...
		<div class="address">
			<img src="images/content/post-it.png" width="885" height="229" class="absolute" />
...
<br /><br />
				...
				<br />UTB,
				<br />Colombia,
				<br /><strong>Sep 21-24, 2013</strong> 
			  <br /><strong>@:</strong> <a href="mailto:info.9thgsf@worldspeed.org">info.9thgsf@worldspeed.org</a></p>
			</div>
		</div>
		
		<br><br>
<div class="cherry-slider" style="height: 180px;">
			<div id="map" style="width: 100%; height: 180px;" class="prevent-swipe-menu absolute map" data-location="Cartagena Colombia"></div>
			<div anim="slide" anim-speed="300" anim-direction="left" anim-position-right="30" anim-position-top="115" class="anim-item"><p class="little-padding white-bg gray-border">Located&nbsp;at&nbsp;Cartagena</p></div>
			<div anim="slide" anim-speed="300" anim-direction="left" anim-position-right="30" anim-position-top="140" class="anim-item"><p class="little-padding white-bg gray-border">Colombia</p></div>
...
if(isset($_POST['email'])) {
    ...
    $email_to = "rake.eks@worldspeed.org";
