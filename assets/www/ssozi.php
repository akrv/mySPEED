...
<div anim="blind" anim-speed="700" anim-direction="left" anim-position-left="0" anim-position-top="20" class="anim-item"><p class="little-padding aa">STUDENT'S</p></div>
  ...
  <div anim="fade" anim-speed="2000" class="anim-item wait-item"></div>
          ...
          <h2 class="only-tablet" align="justify"><strong>JAVIE SSOZI - SPEED 2010 SCHOLARSHIP RECIPIENT</strong></h2>
			<p class="large-text only-tablet" align="justify">
            <img src="images/javie.jpg" width="502" height="450" alt="ssozi">                        
...
<br><br>
After a competitive application process, I was awarded the scholarship. The theme of the forum was "Effective Collaborations Addressing Common and Global Challenges".
<br><br>
Participating in the forum gave me an opportunity to work with a group of engineering students from universities around the world, to learn from one another and also to share ideas on how engineering students can contribute solutions to global challenges.
<br><br>
I got an opportunity of volunteering at an Anglo-Chinese School together with other student to inspire pupils to like engineering and science classes.
<br><br>
I had the privileged of speaking about the "role of mentorship in enhancing students careers" at the World Engineering Education Forum drawing from my own experience in Uganda. 
<br><br>
Since 2010 I have kept World SPEED very close to my heart and have talked to dozens of engineering students about this incredible student led organisation. 
<br><br>
Through Global Students Forum, World SPEED facilitates a very interactive platform for students to learn from one another and share experiences. As a member of World SPEED, my aim is to bring more students from the African continent on board.
